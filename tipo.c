...
static void tipos_inicializar(void)
{
    ...
    for (int i = 0; i < QTDE_TIPOS; i++)
    {
        ...
        {
        case TIPO_BOOL:
            tipos[i] = tipo_criar("bool");
            break;
        case TIPO_CHAR:
            tipos[i] = tipo_criar("char");
            break;
        case TIPO_FLOAT:
            tipos[i] = tipo_criar("float");
            break;
        case TIPO_INT:
            tipos[i] = tipo_criar("int");
            break;
        case TIPO_VOID:
            tipos[i] = tipo_criar("void");
            break;
        default:
    ...
    for (int i = 0; i < QTDE_TIPOS; i++)
    {
        ...
        {
        case TIPO_BOOL:
            tipo_atrib_bytes(tipos[i], sizeof(bool));
            break;
        case TIPO_CHAR:
            tipo_atrib_bytes(tipos[i], sizeof(char));
            break;
        case TIPO_FLOAT:
            tipo_atrib_bytes(tipos[i], sizeof(float));
            break;
        case TIPO_INT:
            tipo_atrib_bytes(tipos[i], sizeof(int));
            break;
        case TIPO_VOID:
            tipo_atrib_bytes(tipos[i], sizeof(void));
            break;
        }
    }
}
...
tipo_t *tipo_obter_resultante(int oper, tipo_t *tipo1, tipo_t *tipo2)
{
    ...
    if (tipo2 == NULL)
    {
        ...
        case T_MENOS:
            ...
            {
            case TIPO_INT:
                return (tipos[TIPO_INT]);
            case TIPO_FLOAT:
                return (tipos[TIPO_FLOAT]);
            default:
                return (NULL);
            }
        case T_NAO:
